...
<body>
 ...
 <font color="green" size="5px">Welcome &nbsp;&nbsp;</font>
 <font color="red" size="5px"> 
<% 
session=request.getSession(false);

out.print(session.getAttribute("uname"));
%><center> <h2>Your Cart </h2>

<%
  String a= (String)session.getAttribute("cart1");
try
{
if(a.equals("empty"))
{
...
{
out.print(a+"<html><body><br></body></html>");	
}
}
catch(Exception e)
{
...
%>
<%
   a= (String)session.getAttribute("cart2");
try
{
if(a.equals("empty"))
{
...
<%
 ...
 a= (String)session.getAttribute("cart3");
try
{
if(a.equals("empty"))
{
...
<%
 ...
 a= (String)session.getAttribute("cart4");
try
{
if(a.equals("empty"))
{
...
<%
 ...
 a= (String)session.getAttribute("cart5");
try
{
if(a.equals("empty"))
{
...
<%
 ...
 a= (String)session.getAttribute("cart6");
try
{
if(a.equals("empty"))
{
...
<%
 ...
 a= (String)session.getAttribute("cart7");
try
{
if(a.equals("empty"))
{
...
<%
 ...
 a= (String)session.getAttribute("cart8");
try
{
if(a.equals("empty"))
{
...
<%
 ...
 a= (String)session.getAttribute("cart9");
try
{
if(a.equals("empty"))
{
...
%>
  ...
  <div>  <center><a href="my-account.jsp" class="ml-auto btn hvr-hover" > Update Your Cart </a></center></form> </div>
</div>
</div>
